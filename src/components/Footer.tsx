        ...
        <nav>
          <ul className="flex flex-col gap-8 justify-center items-center mt-10 lg:flex-row">
            <li>
              <Link
                href="/features"
                className="text-base tracking-[1.73px] uppercase hover:text-[var(--soft-red)] transition duration-300"
              >
                features
              </Link>
            </li>
      ...
      <div className="flex gap-10 items-center">
        <Link href={"/"}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
            <path
              className="hover:fill-[var(--soft-red)] transition-all duration-300"
              fill="#FFF"
              fill-rule="evenodd"
